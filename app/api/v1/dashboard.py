...
Implements RULE-FLOW-001-15: Dashboard summary display.
...
class MonthlyTrendItem:
    ...
    def __init__(self, month: str, total: int):
        self.month = month
        self.total = total
...
class DashboardData:
    ...
    def __init__(
        ...
        self.current_month_total = current_month_total
    ...
    def model_dump(self) -> dict:
        ...
        return {
            ...
            "monthly_trend": [
                {"month": item.month, "total": item.total} for item in self.monthly_trend
            ],
        }
...
async def get_dashboard(
    ...
    Returns:
        DashboardData with monthly/yearly/category totals.
    """
    ...
    monthly_trend = [
        MonthlyTrendItem(month=row.month, total=int(row.total or 0))
